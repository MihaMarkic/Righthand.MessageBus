...
namespace Righthand.MessageBus
{
    ...
    public interface IDispatcher : IDisposable
    {
        ...
        Subscription Subscribe<TKey, TMessage>(TKey key, Action<TKey, TMessage> handler, string name = null);
        /// <summary>
        ...
        /// <param name="name">Optional name of the subscription.</param>
        /// <returns>An instance of <see cref="Subscription"/>.</returns>
        Subscription Subscribe<TMessage>(Action<object, TMessage> handler, string name = null);
        /// <summary>
